...
This is H~2~O
|        ^^^ meta.paragraph.markdown markup.subscript.markdown-pandoc
...
This is @foo
|       ^^^^ meta.paragraph.markdown meta.link.reference.markdown-pandoc
|       ^ meta.paragraph.markdown meta.link.reference.markdown-pandoc constant.other.cite.markdown-pandoc
|        ^^^ meta.paragraph.markdown meta.link.reference.markdown-pandoc keyword.other.cite.markdown-pandoc
